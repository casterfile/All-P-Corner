...
public class MainMenu : MonoBehaviour {
	...
	private string LoginPHP_Url = "http://immersivemedia.ph/potatocornerDB/pc_Account.php";
	protected string tblAccount_Username = "";
    protected string tblAccount_Password = "";
    private bool isLogin = false;
    
    //DataBase Variable Login
	private string PrizeCountPHP_Url = "http://immersivemedia.ph/potatocornerDB/pc_RegisterPrize.php";
	...
	private const string constUsername = "PC272019", constPassword = "betterwithflavor";
...
//			txtTotalPackTC.text  = TotalPactTC+"";
	...
	public void URLPotatocCornerTutorial(){
		Application.OpenURL("http://bit.ly/PotatoCornerCraze");
	}
	//DropDown
...
//	private Image imgSubmit;
	...
	public void URLPotatocCornerTutorialMain(){ //http://immersivemedia.ph/potatocornerWebsite/
		Application.OpenURL("http://immersivemedia.ph/potatocornerWebsite/");//http://bit.ly/PotatoCornerCraze
	}
